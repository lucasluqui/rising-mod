...
class giveaway:
    ...
    async def giveaway(self, ctx, channelId, duration, *, prize):
        if "team" in [y.name.lower() for y in ctx.message.author.roles]:
            ...
            giveaway_embed.set_footer(text='A giveaway made by: {}.'.format(str(ctx.message.author)))
            ...
            giveawayended_embed.set_footer(text='A giveaway made by: {}.'.format(str(ctx.message.author)))
